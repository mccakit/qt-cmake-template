...
add_compile_options(
    -w
    -flto=thin
    --gcc-install-dir=${CMAKE_SYSROOT}/lib/gcc/${triple}/12
)
add_link_options(
    -w
    -flto=thin
...
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -nostdinc++ -nostdlib++ -stdlib=libc++ -isystem /home/mccakit/dev/libcxx/debian-x64/include/c++/v1 -L/home/mccakit/dev/libcxx/debian-x64/lib")
link_libraries(stdc++ gcc_s gcc /home/mccakit/dev/libcxx/debian-x64/lib/libc++.a)
set(Qt6_DIR /home/mccakit/dev/qt/static/debian-x64/lib/cmake/Qt6)
